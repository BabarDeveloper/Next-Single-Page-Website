...
const PricingColumn: React.FC<Props> = ({ tier, highlight }: Props) => {
    ...
    return (
        <div className={clsx("w-full max-w-sm mx-auto bg-white rounded-xl border border-gray-200 lg:max-w-full", { "shadow-lg animate:ping border-2 border-[#FED835]": highlight })}>
